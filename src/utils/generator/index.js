...
App.route('/')
  .get((req, res) => {
    ...
    Repository.all()
      .then(data => {
        context.success(data, '${this.moduleName}.list.success')
      })
      .catch(err => {
        context.error(err)
      })
  ...
  .post((req, res) => {
    ...
    Repository.create(req.query || req.body)
      .then(data => {
        context.success(data, '${this.moduleName}.create.success')
      })
      .catch(err => {
...
App.route('/:id')
  ...
  .put((req, res) => {
    ...
    Repository.update(req.params.id, req.query)
      .then(data => {
        context.success(data, '${this.moduleName}.edit.success')
      })
      .catch(err => {
        context.error(err)
      })
  ...
  .delete((req, res) => {
    ...
    Repository.delete(req.params.id)
      .then(data => {
        context.success(data, '${this.moduleName}.delete.success')
      })
      .catch(err => {
        context.error(err)
      })
